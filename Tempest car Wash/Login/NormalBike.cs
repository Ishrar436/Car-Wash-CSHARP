...
namespace Login
{
    public partial class NormalBike : Form
    {
        ...
        public NormalBike(string username, string usertype)
        {
            InitializeComponent();
        ...
        private void LoadVehicleModels()
        {
            ...
            con.Open();
            string query = "SELECT vehicle_model FROM  VEHICLES WHERE vehicle_type='Two Wheel' AND washtype='Regular'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select an kit Type.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
