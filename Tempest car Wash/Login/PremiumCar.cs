...
namespace Login
{
    public partial class PremiumCar : Form
    {
        ...
        public PremiumCar(string username, string usertype)
        {
            InitializeComponent();
        ...
        private void LoadVehicleModels()
        {
            ...
            con.Open();
            string query = "SELECT vehicle_model FROM VEHICLES WHERE vehicle_type='Four Wheel' AND washtype='Premium'";
